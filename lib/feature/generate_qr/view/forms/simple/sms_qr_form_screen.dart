...
/// Form screen for SMS/WhatsApp QR codes
class SmsQrFormScreen extends BaseQrFormScreen {
  const SmsQrFormScreen({super.key});

  @override
  String get formTitle => LocaleKeys.whatsapp.tr();
    ...
    return Column(
      children: [
        ...
        QrFormField(
          ...
          hint: LocaleKeys.prefilled_message_optional.tr(),
          fieldName: 'message',
          value: state.formData['message'],
          errorText: state.formErrors['message'],
          maxLines: 4,
